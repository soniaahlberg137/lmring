...
| Arena | Leaderboard |
|:-----:|:-----------:|
| ![Arena](docs/assets/arena-main.png) | ![Leaderboard](docs/assets/leaderboard-main.png) |

| Bar Chart | Scatter Plot | Settings |
|:---------:|:------------:|:--------:|
| ![Bar Chart](docs/assets/bar-chart.png) | ![Scatter Plot](docs/assets/scatter.png) | ![Settings](docs/assets/settings.png) |
