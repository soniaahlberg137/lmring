...
export const env = createEnv({
  server: {
    ...
    EMAIL_FROM: z.string().optional().default('noreply@lmring.com'),
  ...
  client: {
    ...
    NEXT_PUBLIC_LINUXDO_AUTH_ENABLED: z.enum(['true', 'false']).default('false'),
    NEXT_PUBLIC_EMAIL_ENABLED: z.enum(['true', 'false']).default('false'),
  },
  shared: {
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_LINUXDO_AUTH_ENABLED: process.env.NEXT_PUBLIC_LINUXDO_AUTH_ENABLED,
